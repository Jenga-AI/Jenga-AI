...
JengaAI uses MLflow for experiment tracking, model management, and versioning.
...
For detailed setup instructions, see [docs/MLFLOW_SETUP.md](docs/MLFLOW_SETUP.md)
